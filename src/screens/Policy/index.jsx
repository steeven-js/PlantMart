...
import DiscSvg from '../../assets/icons/svg/ic_disc_dark_green.svg';
      ...
      <Animatable.View animation="fadeInUp" delay={100}>
        ...
        <ScrollView
          ...
          <View style={styles.policyTitleWrapper}>
            ...
            />
            <Text style={[styles.policyTitle, {color: theme.textHighContrast}]}>
              Policy details
            </Text>
          </View>

          {/* Policy details */}
          <Text style={[styles.policyDetails, {color: theme.textLowContrast}]}>
            ...
            describes how PlatMart Internet Private Limited and its affiliates
            ...
            Platform without registering with us, however, please note we do not
            offer any product/service under this Platform outside India. By
          ...
          <Text style={[styles.policyDetails, {color: theme.textLowContrast}]}>
            ...
            our products and services; inform you about online and offline
            offers, products, services, and updates; customize and enhance your
            ...
            products/services may be affected in the event consent is not
            provided to us.
          </Text>
        </ScrollView>
      </Animatable.View>
