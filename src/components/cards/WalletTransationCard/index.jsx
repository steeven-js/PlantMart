  ...
  return (
    <View
      ...
      <View style={styles.dateTimeAndVendorWrapper}>
        ...
        <View>
          {/* Vendor */}
          <Text style={[styles.vendor, {color: theme.textHighContrast}]}>
            {vendor}
          </Text>

          {/* Transaction date */}
          <Text style={[styles.time, {color: theme.textLowContrast}]}>
            {time}
          </Text>
        </View>
      </View>
      ...
      {/* Transaction amount */}
      <Text style={[styles.transactionAmount, {color: theme.textHighContrast}]}>
        {amount}
      </Text>
    </View>
  );
